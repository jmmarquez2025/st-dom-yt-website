    ...
    >
      <button
        ...
        style={{
          ...
          gap: 12,
          padding: "18px 24px",
          background: open ? "rgba(107,29,42,0.03)" : "transparent",
          border: "none",
          cursor: "pointer",
          textAlign: "left",
      ...
      >
        ...
        {open ? (
          <ChevronUp size={18} color={T.warmGray} />
        ) : (
          <ChevronDown size={18} color={T.warmGray} />
        )}
      </button>
      <div
        style={{
      ...
      >
        <div style={{ padding: "4px 24px 24px", display: "grid", gap: 16 }}>{children}</div>
      </div>
    </div>
  );
}
